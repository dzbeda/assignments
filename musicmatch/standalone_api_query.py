...
song_word_search= input("Enter a word that you wish to search in songs lyrics:") or "car"
song_language = "en"
...
with open(csv_file_output_path,'w', encoding='utf-8',newline='') as csv_file:
    ...
    print("result file can be found in the follwoing path: "+ csv_file_output_path)